...
public interface RMI_interfaceFile extends Remote {
	...
	/*
	 * Quando un metodo del server modifica lo stato ed è accessibile
	 * contemporaneamente da più cliente (tramite l'invocazione remota) Quindi
	 * qualsiasi metodo remoto che modifichi lo stato del server Con stato intendo
	 * la struttura dati che gestisce il server
	 */

	// Esempio di metodi da implementare
	String[] lista_file(String nomeDir) throws RemoteException;
